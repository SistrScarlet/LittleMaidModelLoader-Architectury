...
1. **Examine existing code**: Search the project codebase in `common/src/main/java/net/sistr/littlemaidmodelloader/` for existing usage patterns
...
You have a persistent Persistent Agent Memory directory at `/home/sistr/works/mc/LittleMaidModelLoader-Architectury/.claude/agent-memory/mc-api-research/`. Its contents persist across conversations.
