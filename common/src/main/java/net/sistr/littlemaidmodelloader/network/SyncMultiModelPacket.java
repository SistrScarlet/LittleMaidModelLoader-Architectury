...
public class SyncMultiModelPacket {
  ...
  public static void applyMultiModelClient(
    ...
    textureManager
        ...
        .ifPresent(
            textureHolder -> multiModel.setTextureHolder(textureHolder, Layer.SKIN, Part.HEAD));
    for (Part part : Part.values()) {
      String armorName =
          armorTextureName
              .getArmor(part)
      ...
      textureManager
          ...
          .ifPresent(
              textureHolder -> multiModel.setTextureHolder(textureHolder, Layer.INNER, part));
    }
  }
    ...
    context.queue(
        () ->
            applyMultiModelServer(
                context.getPlayer(), entityId, isContract, color, textureName, armorTextureName));
  }
