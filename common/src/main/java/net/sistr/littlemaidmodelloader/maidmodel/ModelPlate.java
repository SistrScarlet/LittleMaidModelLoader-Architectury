...
public class ModelPlate extends ModelBoxBase {
  ...
  // 互換用パラメーター
  @Deprecated public static final int planeXY = 0;
  @Deprecated public static final int planeZY = 1;
  @Deprecated public static final int planeXZ = 2;
  @Deprecated public static final int planeXYInv = 4;
  @Deprecated public static final int planeZYInv = 5;
  @Deprecated public static final int planeXZInv = 6;
  ...
  /**
   * @param pMRenderer
   * @param pArg textureX, textureY, posX, posY, posZ, width, height, facePlane, sizeAdjust
   */
    ...
    switch (pPlane) {
      ...
      case planeZYRight:
        vertexPositions =
            new PositionTextureVertex[] {
              new PositionTextureVertex(
                  pX, pY, lz, getU(modelrenderer, pTextureX), getV(modelrenderer, pTextureY)),
              new PositionTextureVertex(
                  pX,
                  ly,
                  lz,
                  getU(modelrenderer, pTextureX),
                  getV(modelrenderer, pTextureY + pHeight)),
              new PositionTextureVertex(
                  lx,
                  ly,
                  pZ,
                  getU(modelrenderer, pTextureX + pWidth),
                  getV(modelrenderer, pTextureY + pHeight)),
              new PositionTextureVertex(
                  lx,
                  pY,
      ...
      case planeZYLeft:
        vertexPositions =
            new PositionTextureVertex[] {
              new PositionTextureVertex(
                  lx, pY, pZ, getU(modelrenderer, pTextureX), getV(modelrenderer, pTextureY)),
              new PositionTextureVertex(
                  lx,
                  ly,
                  pZ,
    ...
    if ((pPlane & 0x0010) > 0) {
      ...
      if (lotherplane) {
        ...
        quadList[0] =
            new TexturedQuad(
                new PositionTextureVertex[] {
                  vertexPositions[1], vertexPositions[0], vertexPositions[3], vertexPositions[2]
                },
                pTextureX,
                pTextureY,
                pTextureX + pWidth,
  ...
  public float getU(ModelRenderer pRender, int pU) {
    return (float) pU / pRender.textureWidth;
  }

  public float getV(ModelRenderer pRender, int pV) {
    return (float) pV / pRender.textureHeight;
  }
}
