...
/** モデル共通化用インターフェース。 形式指定の値読み出しはModelCapsHelperを使うこと。 */
public interface IModelCaps {
  ...
  /**
   * 乗っかっているEntityのTypeを文字列で返却する リトルメイド（メイドMod側で実装）:littlemaid プレイヤー:player 動物系:animal モブ系:mob
   * それ以外:entity 騎乗なし:null
   */
  ...
  /** 騎乗時の高さ調整用offset Entity.getYOffset() の数値により調整する必要あり */
  ...
  @Deprecated int caps_HeadMount = 0x0132;
