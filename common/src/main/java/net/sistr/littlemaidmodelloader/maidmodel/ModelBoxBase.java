...
public abstract class ModelBoxBase {
    ...
    public static class PositionTextureVertex {
        ...
        public PositionTextureVertex(
                PositionTextureVertex textureVertex,
                float texturePositionXIn,
    ...
    public static class TexturedQuad {
        ...
        public TexturedQuad(
            ...
            vertices[0] =
                    vertices[0].setTexturePosition(
                            (float) texcoordU2 / textureWidth - f,
                            (float) texcoordV1 / textureHeight + f1);
            vertices[1] =
                    vertices[1].setTexturePosition(
                            (float) texcoordU1 / textureWidth + f,
                            (float) texcoordV1 / textureHeight + f1);
            vertices[2] =
        ...
        public void flipFace() {
            PositionTextureVertex[] vertices =
                    new PositionTextureVertex[this.vertexPositions.length];
        ...
        public final void draw(
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                Vector4f uv =
                        new Vector4f(vertex.texturePositionX, vertex.texturePositionY, 0, 1.0F);
