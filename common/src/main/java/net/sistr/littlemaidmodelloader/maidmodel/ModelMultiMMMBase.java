...
/** MMMの実験コードを含む部分。 ModelMultiBaseに追加するに足りるかをここで実験。 このクラスにある機能は予告なく削除される恐れが有るためご留意下さい。 */
...
public abstract class ModelMultiMMMBase extends ModelMultiBase {
  ...
  public int setFaceTexture(int pIndex) {
    ...
    GL11.glTranslatef(
        ((pIndex & 0x01) * 32) / textureWidth, (((pIndex >>> 1) & 0x01) * 16) / textureHeight, 0F);
    return pIndex / 4;
  }
