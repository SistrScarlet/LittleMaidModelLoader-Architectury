...
public class ModelRenderer {
  ...
  public static void setParam(
      MMMatrixStack matrixStack,
      MMVertexConsumer buffer,
      int light,
      int overlay,
      float red,
      float green,
  ...
  public ModelRenderer(
      ModelBase pModelBase, int px, int py, float pScaleX, float pScaleY, float pScaleZ) {
  ...
  public ModelRenderer addBox(
      String pName, float pX, float pY, float pZ, int pWidth, int pHeight, int pDepth) {
  ...
  public ModelRenderer addBox(
      float pX, float pY, float pZ, int pWidth, int pHeight, int pDepth, float pSizeAdjust) {
  ...
  protected ModelBoxBase getModelBoxBase(
      Class<? extends ModelBoxBase> pModelBoxBase, Object... pArg) {
    try {
  ...
  public ModelRenderer addParts(
      Class<? extends ModelBoxBase> pModelBoxBase, String pName, Object... pArg) {
    pName = boxName + "." + pName;
  ...
  public ModelRenderer addPartsTexture(
      Class<? extends ModelBoxBase> pModelBoxBase, String pName, Object... pArg) {
    pName = boxName + "." + pName;
  ...
  public ModelRenderer addPlate(
      float pX, float pY, float pZ, int pWidth, int pHeight, int pFacePlane) {
    addParts(ModelPlate.class, pX, pY, pZ, pWidth, pHeight, pFacePlane, 0.0F);
    return this;
  }

  public ModelRenderer addPlate(
      float pX, float pY, float pZ, int pWidth, int pHeight, int pFacePlane, float pSizeAdjust) {
    addParts(ModelPlate.class, pX, pY, pZ, pWidth, pHeight, pFacePlane, pSizeAdjust);
    return this;
  }

  public ModelRenderer addPlate(
      String pName, float pX, float pY, float pZ, int pWidth, int pHeight, int pFacePlane) {
  ...
  public boolean renderItems(
      ModelMultiBase pModelMulti, IModelCaps pEntityCaps, boolean pRealBlock, int pIndex) {
    return true;
  }
    ...
    switch (rotatePriority) {
      case RotXYZ:
        if (rotateAngleZ != 0.0F) {
          matrixStack.multiply(RotationAxis.POSITIVE_Z.rotation(rotateAngleZ));
        }
        if (rotateAngleY != 0.0F) {
          matrixStack.multiply(RotationAxis.POSITIVE_Y.rotation(rotateAngleY));
        }
        if (rotateAngleX != 0.0F) {
          matrixStack.multiply(RotationAxis.POSITIVE_X.rotation(rotateAngleX));
        }
        break;
      case RotXZY:
        if (rotateAngleY != 0.0F) {
