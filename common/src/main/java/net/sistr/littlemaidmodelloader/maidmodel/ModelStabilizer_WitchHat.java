...
public class ModelStabilizer_WitchHat extends ModelStabilizerBase {
    ...
    public ModelStabilizer_WitchHat() {
        ...
        WitchHat1.setTextureOffset(40, 4)
                .addBox(-3F, -3F, -3F, 6, 3, 6)
                .setRotationPoint(0F, -4F, 0F);
        WitchHat2.setTextureOffset(28, 0)
                .addBox(-2F, -2F, -2F, 4, 2, 4)
                .setRotationPoint(0F, -3F, 0F);
        WitchHat3.setTextureOffset(0, 0)
                .addBox(-1F, -2F, -1F, 2, 2, 2)
