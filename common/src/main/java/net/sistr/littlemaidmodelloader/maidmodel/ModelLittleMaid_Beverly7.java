...
public class ModelLittleMaid_Beverly7 extends ModelLittleMaidBase {
    ...
    /** �R���X�g���N�^�͑S�Čp�������邱�� */
    public ModelLittleMaid_Beverly7(
            float psize, float pyoffset, int pTextureWidth, int pTextureHeight) {
    ...
    public void setLivingAnimations(
            IModelCaps pEntityCaps, float f, float f1, float pRenderPartialTicks) {
        // INIT POSITION
        ...
        bipedHead.rotateAngleZ =
                ModelCapsHelper.getCapsValueFloat(
                        pEntityCaps, caps_interestedAngle, (Float) pRenderPartialTicks);
        ...
        blinkFreq +=
                1F
                        - (float) ModelCapsHelper.getCapsValueInt(pEntityCaps, caps_health)
                                / 20F; // �̗͏��Ȃ��Ƃ܂΂��������Ȃ�
        ...
        // �W�����v�ӂ��
        // コメントアウト sistr
        // EntityLivingBase ent = (EntityLivingBase)ModelCapsHelper.getCapsValue(pEntityCaps,
        // caps_Entity);
        ...
        // x.1.0での追加
        float roll =
                ModelCapsHelper.getCapsValueInt(pEntityCaps, IModelCaps.caps_roll)
                        + pRenderPartialTicks;
    ...
    public void setRotationAngles(
        ...
        // �|�j�e�c�C���e
        Ponytail.rotateAngleX +=
                BunchR.rotateAngleX = BunchL.rotateAngleX = -bipedHead.rotateAngleX;
        ...
        if (isRiding) {
            ...
            if (isSneak
                    || !ModelCapsHelper.getCapsValueBoolean(
                            pEntityCaps, caps_PosBlockAir, 0D, 2D, 0D)) // ���Ⴊ�� ���㒍��
            {
                if (isWait) { // �G����
                ...
                breastR.rotateAngleX -=
                        f16 * f16 * 0.18F * f1 - mh_sin(ticksExisted * 0.057F) * 0.05F;
                breastL.rotateAngleX -=
                        f16 * f16 * 0.18F * f1 - mh_sin(ticksExisted * 0.057F) * 0.05F;
        ...
        //
        Arms[2].setRotateAngle(
                -0.78539816339744830961566084581988F - upperRightArm.getRotateAngleX(), 0F, 0F);
        Arms[3].setRotateAngle(
                -0.78539816339744830961566084581988F - upperLeftArm.getRotateAngleX(), 0F, 0F);
        ...
        float jsUp =
                (upperRightLeg.rotateAngleX + upperLeftLeg.rotateAngleX) / 2F
