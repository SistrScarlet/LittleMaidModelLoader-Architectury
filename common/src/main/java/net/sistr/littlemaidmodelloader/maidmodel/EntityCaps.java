    ...
    static {
        ...
        register(
                ...
                (entity, arg) -> {
                    ...
                    BlockPos min =
                            BlockPos.ofFloored(
                                    box.minX + 1.0E-7, box.minY + 1.0E-7, box.minZ + 1.0E-7);
                    BlockPos max =
                            BlockPos.ofFloored(
                                    box.maxX - 1.0E-7, box.maxY - 1.0E-7, box.maxZ - 1.0E-7);
                            ...
                            for (int j = min.getY(); j <= max.getY(); ++j) {
                                for (int k = min.getZ(); k <= max.getZ(); ++k) {
                                    ...
                                    BlockState blockState =
                                            entity.getWorld().getBlockState(mutable);
        ...
        register(
                "isSwingInProgress",
                caps_isSwingInProgress,
                (entity, arg) -> 0 < entity.handSwingProgress);
        ...
        register(
                "WorldTotalTime",
                caps_WorldTotalTime,
                (entity, arg) -> entity.getEntityWorld().getTime());
        register(
                "WorldTime",
                caps_WorldTime,
                (entity, arg) -> entity.getEntityWorld().getTimeOfDay());
        register(
                "MoonPhase",
                caps_MoonPhase,
                (entity, arg) -> entity.getEntityWorld().getMoonPhase());
        ...
        register(
                "lastLeaningPitch",
                caps_lastLeaningPitch,
                (entity, arg) -> entity.getLeaningPitch(0F));
