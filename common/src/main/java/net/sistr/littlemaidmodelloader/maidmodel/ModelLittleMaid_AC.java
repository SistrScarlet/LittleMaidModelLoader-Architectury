...
public class ModelLittleMaid_AC extends ModelMultiMMMBase {
  ...
  public void initModel(float psize, float pyoffset) {
    ...
    */
    //
    //		Arms[2].setRotateAngle(-0.78539816339744830961566084581988F -
    // bipedRightArm.getRotateAngleX(), 0F, 0F);
    //		Arms[3].setRotateAngle(-0.78539816339744830961566084581988F -
    // bipedLeftArm.getRotateAngleX(), 0F, 0F);
