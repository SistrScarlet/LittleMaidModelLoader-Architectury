...
public class ModelLittleMaid_Aug extends ModelLittleMaid_SR2 {
  ...
  public void initModel(float psize, float pyoffset) {
    ...
    SideTailR.setTextureOffset(46, 20)
        .addParts(ModelBox.class, -1.5F, -0.5F, -1.0F, 2, 10, 2, psize);
    SideTailR.setRotationPoint(-5F, -7.8F, 1.9F);
    SideTailL = new ModelRenderer(this);
    SideTailL.setTextureOffset(54, 20)
        .addParts(ModelBox.class, 0.5F, -0.5F, -1.0F, 2, 10, 2, psize);
    ...
    bipedHead
        ...
        .addParts(ModelBox.class, -4F, -8F, -4F, 8, 8, 8, psize); // Head
    bipedHead
        .setTextureOffset(0, 18)
        .addParts(ModelBox.class, -5F, -8.5F, 0.2F, 1, 3, 3, psize); // ChignonR
    bipedHead
        .setTextureOffset(24, 18)
        .addParts(ModelBox.class, 4F, -8.5F, 0.2F, 1, 3, 3, psize); // ChignonL
    bipedHead
        .setTextureOffset(52, 10)
        .addParts(ModelBox.class, -7.5F, -9.5F, 0.9F, 4, 3, 2, psize); // sidetailUpperR
    bipedHead
        .setTextureOffset(52, 15)
        .addParts(ModelBox.class, 3.5F, -9.5F, 0.9F, 4, 3, 2, psize); // sidetailUpperL
  ...
  public void setLivingAnimations(
      IModelCaps pEntityCaps, float par2, float par3, float pRenderPartialTicks) {
    ...
    sensor3.setRotateAngle(
        mh_sin(f3 * 0.067F) * 0.05F - 1.2F - f4,
        mh_sin(f3 * 0.09F) * 0.4F,
        mh_cos(f3 * 0.09F) * 0.2F);
    sensor4.setRotateAngle(
        mh_sin(f3 * 0.067F) * 0.05F + f4, mh_cos(f3 * 0.09F) * 0.5F, mh_sin(f3 * 0.09F) * 0.2F);
  }
  ...
  public void setRotationAngles(
    ...
    SideTailR.setRotateAngleX(
        SideTailL.setRotateAngleX(bipedHead.getRotateAngleX() * -0.666666666F));
  }
}
