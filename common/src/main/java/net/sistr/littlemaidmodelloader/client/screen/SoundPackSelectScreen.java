...
public class SoundPackSelectScreen<T extends Entity & SoundPlayable> extends Screen {
    ...
    protected void init() {
        ...
        FilterPredicate<SoundPackGUI> soundPackFilter =
                (soundPackGUI, filterText) -> {
        ...
        this.soundPackListGUI =
                FilterableListGUI.<SoundPackGUI>builder()
    ...
    public boolean mouseScrolled(
        ...
        if (this.soundPackListGUI.mouseScrolled(mouseX, mouseY, horizontalAmount, verticalAmount)) {
            return true;
        }
    ...
    public void removed() {
        ...
        soundPackListGUI
                ...
                .ifPresent(
                        gui ->
                                SyncSoundPackPacket.sendC2SPacket(
                                        this.entity, gui.getConfigHolder()));
    }
    ...
    public static class SoundPackGUI extends GUIElement implements ListGUIElement {
        ...
        public void render(DrawContext context, int mouseX, int mouseY, float delta) {
            context.drawText(
                    textRenderer, configHolder.getPackName(), this.x, this.y + 1, 0xffffff, false);
            context.drawText(
                    textRenderer,
                    configHolder.getParentName(),
                    this.x,
                    this.y + 1 + (textRenderer.fontHeight + 1),
                    0xffffff,
                    false);
            context.drawText(
                    textRenderer,
                    ...
                    this.x,
                    this.y + 1 + (textRenderer.fontHeight + 1) * 2,
                    0xffffff,
                    false);
            context.fill(
                    this.x,
