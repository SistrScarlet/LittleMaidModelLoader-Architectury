...
public class TextureHolder {
  ...
  public Optional<Identifier> getArmorTextureInner(
    ...
    switch (layer) {
      case INNER:
        index =
            (isLight ? TextureIndexes.ARMOR_1_DAMAGED_LIGHT : TextureIndexes.ARMOR_1_DAMAGED)
                .getIndexMin();
        break;
      case OUTER:
        index =
            (isLight ? TextureIndexes.ARMOR_2_DAMAGED_LIGHT : TextureIndexes.ARMOR_2_DAMAGED)
                .getIndexMin();
        break;
      default:
