...
public class LMModelManager {
    ...
    public void addModel(String modelName, Class<? extends ModelMultiBase> modelClass) {
        try {
            Constructor<? extends ModelMultiBase> constructor =
                    modelClass.getConstructor(float.class);
        ...
        if (LMMLMod.getConfig().isDebugMode()) LOGGER.debug("Loaded Model : " + modelClass);
    }
